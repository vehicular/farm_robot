...
// -----------------------------------------------------------------------------
dwBool smpl_getDataf32(float32_t *value, dwTime_t* timestamp, uint32_t idx, void *userData)
{
    (void)idx;
    (void)userData;
...
// -----------------------------------------------------------------------------
dwBool smpl_getDatai32(int32_t *value, dwTime_t* timestamp, uint32_t idx, void *userData)
{
    (void)idx;
    (void)value;
    (void)userData;
...
void smpl_addMessage(const dwCANMessage *msg, void *userData)
{
    ...
    case DW_CAN_STEERING_ANGLE:
        ...
        g_state.steering_rad     = static_cast<float32_t>(data.ival)
                                 * 6.25e-7f * 16.f; // our sample data stores angles divided by 16
        break;
